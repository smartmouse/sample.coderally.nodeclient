...
function Car (obj) {
	...
	// Private Fields
	var attributes = obj.carAttributes;		// CarAttribute object that holds configuration for defined car attributes
	var control = obj.carControl;			// CarControl object that controls the car	
	var status;								// CarStatus Object 
	...
	self.getCurrentControl = function () {return control;}
	...
	self.getCarControl = function(carControl) {
		return control;
	}
